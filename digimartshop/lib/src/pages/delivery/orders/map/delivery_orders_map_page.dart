...
import 'package:digimartbox/src/pages/delivery/orders/map/delivery_orders_map_controller.dart';
...
class DeliveryOrdersMapPage extends StatelessWidget {
  ...
  final DeliveryOrdersMapController controller = Get.put(DeliveryOrdersMapController());
  ...
  Widget _buttonAccept(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () => controller.updateOrderToDelivered(),
  ...
  Widget _imageClient() {
    return SizedBox(
      ...
      child: ClipRRect(
        ...
        child: FadeInImage(
          image: controller.order.user.image != null
            ? NetworkImage(controller.order.user.image)
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(''
            '${controller.order.user.firstName} ${controller.order.user.lastName}',
